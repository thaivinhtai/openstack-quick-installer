...
EOF
    ...
    openstack endpoint create --region ${REGION_NAME} \
            placement internal http://$INTER_FQDN_CTL:8778/
    openstack endpoint create --region ${REGION_NAME} \
    ...
    openstack endpoint create --region ${REGION_NAME} placement internal http://$INTER_FQDN_CTL:8778
    ...
    ops_edit $placement_conf keystone_authtoken auth_url http://$MGNT_FQDN_CTL:5000/v3
